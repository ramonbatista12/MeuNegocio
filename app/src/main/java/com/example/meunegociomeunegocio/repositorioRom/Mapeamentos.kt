...
data class Endereco(val id: Int,val idCli:Int,val cidade:String,val estado:String,val bairro:String,val complemento:String,val rua:String,val numero:String)
